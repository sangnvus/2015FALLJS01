...
angular.module('blockUI').run(['$templateCache', function($templateCache){
    ...
    $templateCache.put('angular-block-ui/angular-block-ui.ng.html', '<div class=\"block-ui-overlay\"></div><div class=\"block-ui-message-container\" aria-live=\"assertive\" aria-atomic=\"true\"><div class=\"spinner-loader\" ></div></div>');
}]);
})(angular);
