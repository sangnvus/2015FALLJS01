...
app.controller('AdminCategoryController', function ($scope, $rootScope, toastr, listcategory, AdminCategoryService, CommmonService, DTOptionsBuilder, DTColumnDefBuilder) {
    //Todo here.
